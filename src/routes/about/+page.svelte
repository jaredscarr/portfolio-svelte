...
<section>
  <div class="container max-w-6xl mx-auto px-10 sm:px-100 pb-20 sm:pb-40 text-justify">
    {#if animate}
    <h2
      class="h2 mt-20 mb-10 sm:mb-20 font-bold tracking-widest text-primary-700-200-token"
      in:fly={{
      x: -500,
        delay: 100,
        duration: 1500,
